...
- libhotstuff_tx: 
The main code base is taken from Hotstuff repository libhotstuff_ and 
added support for small-bank transactions.
- Themis_tx: 
We have implemented Themis based on the algorithms given in the paper Themis_. 
...
.. _libhotstuff: https://github.com/hot-stuff/libhotstuff.git
.. _Themis: https://www.cs.cornell.edu/~mahimna/themis.pdf
